...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse2002ResultContent', 'model/ResponseMetadata'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2002ResultContent'), require('./ResponseMetadata'));
  } else {
    // Browser globals (root is window)
    if (!root.ApTermsMicroservice) {
      root.ApTermsMicroservice = {};
    }
    root.ApTermsMicroservice.InlineResponse2002Result = factory(root.ApTermsMicroservice.ApiClient, root.ApTermsMicroservice.InlineResponse2002ResultContent, root.ApTermsMicroservice.ResponseMetadata);
  }
}(this, function(ApiClient, InlineResponse2002ResultContent, ResponseMetadata) {
  'use strict';
