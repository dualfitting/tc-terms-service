...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TermsdocusignviewURLParam'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TermsdocusignviewURLParam'));
  } else {
    // Browser globals (root is window)
    if (!root.ApTermsMicroservice) {
      root.ApTermsMicroservice = {};
    }
    root.ApTermsMicroservice.Body = factory(root.ApTermsMicroservice.ApiClient, root.ApTermsMicroservice.TermsdocusignviewURLParam);
  }
}(this, function(ApiClient, TermsdocusignviewURLParam) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('param')) {
        obj['param'] = TermsdocusignviewURLParam.constructFromObject(data['param']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/TermsdocusignviewURLParam} param
   */
