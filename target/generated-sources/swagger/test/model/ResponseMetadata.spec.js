...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApTermsMicroservice.ResponseMetadata();
  });
  ...
  describe('ResponseMetadata', function() {
    it('should create an instance of ResponseMetadata', function() {
      ...
      //var instane = new ApTermsMicroservice.ResponseMetadata();
      //expect(instance).to.be.a(ApTermsMicroservice.ResponseMetadata);
    });
